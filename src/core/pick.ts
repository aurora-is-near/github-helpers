...
function getNestedValue<T, K extends NestedKeys<T>>(obj: T, key: K): unknown {
  return (key as string)
    .split('.')
    .reduce((o: unknown, k: string) => (o && typeof o === 'object' && k in o ? (o as Record<string, unknown>)[k] : undefined), obj);
}

function setNestedValue<T, K extends NestedKeys<T>>(obj: T, path: K, value: unknown): void {
